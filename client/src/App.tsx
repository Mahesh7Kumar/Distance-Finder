        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-slate-800 p-4 rounded-md border border-slate-700">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <Input label="Longitude" value={newUser.longitude} onChange={e => setNewUser(prev => ({ ...prev, longitude: parseFloat(e.target.value)  }))} />
              </div>
          ...
          <div className="bg-slate-800 p-4 rounded-md border border-slate-700">
            ...
            <div className="grid grid-cols-2 gap-2 mb-3">
              <Input label="Latitude" value={center.latitude} onChange={e => setCenter(prev => ({ ...prev, latitude: parseFloat(e.target.value)  }))} />
              <Input label="Longitude" value={center.longitude} onChange={e => setCenter(prev => ({ ...prev, longitude: parseFloat(e.target.value)  }))} />
            </div>
            <div className="flex gap-2">
